...
import main.java.com.polimi.app.controllers.Effect6;
...
public class Effect6Test {
    ...
    public void effectTest(){
        controller = new Effect6();
        Packet packet = new Packet("PLAY_CHARACTER", 0, 0);
        controller.ActivateEffect(context, packet);
        assertEquals(6, context.getPlayedCharacterByPlayerId(0).get("effect"));
    }
}